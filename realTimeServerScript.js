...
function onPlayerAccepted(player) {
  ...
  const msg = session.newTextGameMessage(
    OP_CODE_PLAYER_ACCEPTED,
    player.peerId,
...
function onPlayerDisconnect(peerId) {
  ...
  const outMessage = session.newTextGameMessage(
    OP_CODE_DISCONNECT_NOTIFICATION,
    session.getServerId(),
